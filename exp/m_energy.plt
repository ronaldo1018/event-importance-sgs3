...
set label "M: Video Player" at -0.8,95 font "Times-Roman,24"
set label "L1: ZIP" at -0.8,87 font "Times-Roman,24"
set label "L2: FTP" at -0.8,79 font "Times-Roman,24"
...
set output "m_energy.eps"
plot 'm_energy.dat' u 2:xtic(1) ti column fs pattern 0 lt -1,\
